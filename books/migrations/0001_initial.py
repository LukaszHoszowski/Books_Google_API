# Generated by Django 4.0.1 on 2022-01-30 20:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('lang', models.CharField(help_text='Language', max_length=200)),
            ],
            options={
                'ordering': ['lang'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ManyToManyField(help_text='Authors list', related_name='authors', to='books.Author')),
                ('language', models.ForeignKey(help_text='Book language', on_delete=django.db.models.deletion.DO_NOTHING, to='books.language')),
            ],
            options={
                'ordering': ['title'],
            },
